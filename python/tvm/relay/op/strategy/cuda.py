...
def deformable_conv2d_strategy_cuda(attrs, inputs, out_type, target):
    ...
    if data_layout == 'NCHW' and offset_layout == 'NCHW':
        ...
        strategy.add_implementation(
            wrap_compute_deformable_conv2d(topi.cuda.deformable_conv2d_nhwc_nchw_nchw),
            wrap_topi_schedule(topi.cuda.schedule_deformable_conv2d_nhwc_nchw_nchw),
            name="deformable_conv2d_nhwc_nchw_nchw.cuda")
    return strategy
