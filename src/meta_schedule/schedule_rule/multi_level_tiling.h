...
class MultiLevelTilingNode : public ScheduleRuleNode {
 ...
 protected:
  ...
  tir::BlockRV GetRootBlockRV(const tir::Schedule& sch, tir::BlockRV block_rv) const;
  Optional<tir::LoopRV> TransformWithTensorIntrin(State& state, const String& intrin_name) const;
